    ...
    return (
      <main className={'about-page'}>
        <div className={'container'}>
          ...
          <p>
            Sitio web elaborado por <Hyperlink href="http://keilermora.dualemento.com">Keiler Mora</Hyperlink> con fines demostrativos. El proyecto fue desarrollado usando las
            librerías de JavaScript <Hyperlink href="https://reactjs.org/">React</Hyperlink> y <Hyperlink href="https://redux.js.org/.org/">Redux</Hyperlink> para
            crear la interfaz de usuario, en comunicación con la base de datos alojada en <Hyperlink href="https://www.graph.cool/">Graphcool</Hyperlink>.
            <br/><br/>          
            El código fuente está disponible en <Hyperlink href="https://github.com/keilermora/alicias-favorite-books">Github</Hyperlink>.
          </p>
          <Link to="/">
